...
bool driver_init_device(int device, snd_format_t *p_format);
...
snd_driver_interface_t impl_null_dt = IDDI_INIT_FUNCTIONS(0, "NULL_DRIVER", driver_query_devices_number, driver_query_device_information, driver_format_is_supported, driver_init_device, driver_switch_device, driver_shutdown, driver_lock, driver_unlock, driver_wait, driver_send_data, driver_set_listen_samples_callback);
